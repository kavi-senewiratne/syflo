 ...
 *   - POST /inference → JSON { text }, where text reflects the received
 *     multipart fields so tests can verify what actually arrived at the
 *     server (e.g. language=auto, file size).
 *
